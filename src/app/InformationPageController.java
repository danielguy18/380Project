...
public class InformationPageController {
    ...
    @FXML
    void BtnGuestInformationClicked(ActionEvent event) throws IOException {
      Parent root = FXMLLoader.load(getClass().getResource("GuestInformation.fxml"));
    ...
    @FXML
    void BtnManagersInformationClicked(ActionEvent event) throws IOException {
